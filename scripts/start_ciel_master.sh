...
ciel master --pidfile="$PID_DIR/$HOST_NAME" --daemonise --logfile="$LOG_DIR/$HOST_NAME.log" --blockstore="$BS_DIR" --journaldir="$JJ_DIR" --task-log-root="$LOG_DIR/$HOST_NAME_task_state.log" 
